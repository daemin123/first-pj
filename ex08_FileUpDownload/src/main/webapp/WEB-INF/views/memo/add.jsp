...
<body class="m-2 p-2">
		...
		<div class="container">
			...
			<form action="${pageContext.request.contextPath}/memo/add" method="post">
				...
				<div  class="m-2 w-50">
					<div style="font-size:.7rem; color:orange; margin:0 5px;">${id} </div>
					<input name="id" placeholder="insert id" class="form-control"	/>			
				</div>				
				<div class="m-2 w-50">
					<div style="font-size:.7rem; color:orange; margin:0 5px;">${text} </div>
					<textarea name="text" placeholder="insert memo" class="form-control"></textarea>				
				</div>
				<div  class="m-2 w-50">
					<div style="font-size:.7rem; color:orange; margin:0 5px;">${writer} </div>
					<input name="writer" placeholder="insert writer" class="form-control"	/>			
				</div>
				<div  class="m-2 w-50">
					<div style="font-size:.7rem; color:orange; margin:0 5px;">${regdate} </div>
