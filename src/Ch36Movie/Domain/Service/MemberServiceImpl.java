...
import Ch36Movie.Domain.Dao.MemberDao;
import Ch36Movie.Domain.Dao.MemberDaoImpl;
import Ch36Movie.Domain.Dao.SessionDaoImpl;
...
public class MemberServiceImpl implements MemberService {
	...
	public Map<String,Object> login(String username,String password,int SessiondId) throws Exception {
		...
		MemberDto savedUser =  getId(username);
		if(savedUser==null) {
			result.put("response", false);
