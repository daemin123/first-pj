...
class C05Simple{
	...
	void Func1() {
		// this 예약어는 객체 자기 자신을 말함.
		num=5; // 값 초기화일뿐 변수 선언은 아님 --> 멤버 변수
		System.out.println("변수 num : " + num);
		int num=10;	//Func1의 지역변수({}내에서 선언된 num --> 지역변수)
		System.out.println("변수 num : " + num);
		num++;		//Func1의 지역변수 num의 값 1증가
		System.out.println("변수 num : " + num);
		this.num++;	//멤버변수 num의 값 1증가(this-> 만들어진 객체에 접근 --> 멤버변수에 접근)
